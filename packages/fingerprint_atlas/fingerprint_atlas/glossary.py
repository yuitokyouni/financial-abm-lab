...
GLOSSARY: list[Entry] = [
    ...
    {"en": "loss aversion",
     "ja_primary": "損失回避",
     "ja_also": ["損失への忌避感", "損失への嫌悪感"],
     "notes": "同額の利得より損失を強く嫌う心理。Tversky-Kahneman の prospect theory では λ ≈ 2.25 (損失の苦しみは同額利得の喜びの 2.25 倍) と推定。",
     "domain": "financial-abm"},
    {"en": "aversion",
     "ja_primary": "嫌悪感",
     "ja_also": ["忌避感", "回避"],
     "notes": "X-aversion = X を嫌う / 避けたがる心理(loss aversion, risk aversion, ambiguity aversion 等)。",
     "domain": "financial-abm"},
    {"en": "risk aversion",
     "ja_primary": "リスク回避",
     "ja_also": ["リスクへの嫌悪感"],
     "notes": "不確実性(分散)を嫌う心理。期待値が同じなら確実な選択肢を選ぶ傾向。",
     "domain": "financial-abm"},
    {"en": "round-trip trade",
     "ja_primary": "往復取引",
