...
[`packages/abm_models/abm_models/lux_marchesi/`](../../packages/abm_models/abm_models/lux_marchesi/) を利用し、複製しない。
...
```sh
uv run python -m experiments.YH002.baseline --seed 42
```
...
- [YH002](../../imported/speculation-game-info/experiments/YH002/) — 履歴と保存済み結果を保持。書き換えない。
