...
著名議案の ground truth (experiments/YH010g/data/fixtures/validation_groundtruth.csv) に対し、規則ベース
...
任意の EDINET 属性CSV (build_attributes の出力、政策保有等) をマージして供給する。
    ...
    uv run python -m yh010g.validate_policy --edinet experiments/YH010g/data/processed/attributes.csv
...
from yh010g.paths import FIXTURE_DIR, OUT_DIR

GROUND_TRUTH = FIXTURE_DIR / "validation_groundtruth.csv"
