...
出力: experiments/YH010g/data/processed/panel_long.parquet + panel_sidecar.json

各社のExcel/CSV提供開始とファイル命名は experiments/YH010g/docs/2026-07-23-YH010g-disclosure-inventory.md
...
build は experiments/YH010g/data/raw/ にある取得済みファイル全てを対象とする。
"""
...
from yh010g.paths import RAW_DIR
from yh010g.paths import OUT_DIR
