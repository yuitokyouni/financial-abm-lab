...
出力: experiments/YH010g/data/processed/iv1_report.json (介入は共有 Intervention API で記録)
...
# 追随タイプ混成の2設定 (experiments/YH010g/docs/2026-07-23-YH010g-share-and-novelty-survey.md の較正方針):
