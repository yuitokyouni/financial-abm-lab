...
構造の根拠は experiments/YH010g/docs/2026-07-23-YH010g-disclosure-inventory.md の実査記録。
実ファイルでの煙테스트は experiments/YH010g/data/raw/ が存在する環境でのみ実行される (test_real_files)。
"""
