...
`docs/audit/P0_rerun_yh007_8_p3d.json` + `P0_control_oldvalues_yh007_8_p3d.json`、
...
3. **上記追記の頑健性再走の原 run 構成は復元不能として恒久クローズ**(記録された
   ...
   詳細: `docs/audit/P0_yh007_recalibration_rerun.md`。
