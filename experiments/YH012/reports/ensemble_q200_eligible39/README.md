...
> **2026-09-17 訂正:** この実験はPython RNGの状態コピー不具合を含む旧実装で実行された。
> 以下は当時の出力の保存記録であり、修正後の経済的なインパクト応答として解釈しない。
> [不具合と修正](https://github.com/yuitokyouni/lobcore/blob/main/docs/python-rng-correction.md)。元ログと数値は変更しない。
> [修正後の同一39 seed再実験](../ensemble_q200_rng_fixed39_20260917/README.md)が完了した。
