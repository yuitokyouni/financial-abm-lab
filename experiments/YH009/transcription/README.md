...
- 置き場所: `experiments/YH009/inputs/pdfs_supplied/S0XX__<issuer>_<kind>.pdf`
...
python3 experiments/YH009/scripts/apply_transcription.py --check
# 3) 検証OK(ERROR無し)なら legs.csv に反映
python3 experiments/YH009/scripts/apply_transcription.py --apply
# 4) 下流を再計算
